const PRODUCT={id:'ultimate-video-ai-mastery',offerPrice:'9.99',regularPrice:'19.99',currency:'USD'};
...
function validPrice(price){return [PRODUCT.offerPrice,PRODUCT.regularPrice,'19.00','29.00','29.99','49.99','99.00'].includes(price);}
